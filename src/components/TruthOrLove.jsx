                        ...
                        {isCompleted ? (
                            <div className={`p-8 rounded-2xl border text-center ${mode === 'truth'
                                ...
                                {mode === 'truth' ? (
                                    ...
                                    <button onClick={() => { setMode(null); setIsCompleted(false); setTruthIndex(0); setLoveIndex(0); }} className="w-full py-4 rounded-xl bg-white/10 text-white hover:bg-white/20 transition-colors">
                                        Back to Menu
                                    </button>
                                )}
                            </div>
                            ...
                            <>
                                ...
                                <div className="grid grid-cols-3 gap-2">
                                    ...
                                    <button onClick={handleRandom} className="py-3 rounded-xl bg-white/5 text-white/50 hover:text-white/70 transition-colors text-sm border border-white/10">
                                        🎲 Random
                                    </button>
                                    <button
                                        onClick={handleNext}
